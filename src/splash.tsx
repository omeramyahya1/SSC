...
/**
 * Disable Context Menu defintely for the splash screen in prod mode
 */
...
export async function runSplashScreenLogic() {
  try {
    ...
    const latestAuth = await useAuthenticationStore
      .getState()
    ...
    await invoke("splash_screen").catch((e) =>
      console.error("Failed to close splash screen on error:", e),
    );
  }
}
