  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn("bg-primary-light", defaultClassNames.range_middle),
        range_end: cn(
          "bg-accent text-white rounded-r-md",
        ...
        outside: cn(
          "text-slate-300 aria-selected:text-muted-foreground disabled",
          defaultClassNames.outside,
        ),
        disabled: cn(
          "invisible text-muted-foreground opacity-50",
