      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {isAdmin && (
              ...
              >
                <SelectTrigger
                  className={`h-auto 8 w-fit gap-2 ${selectedBranch !== "all" ? "bg-primary text-white" : "bg-white"} `}
                >
                  <Building2 className="h-4 w-4 opacity-60" />
                  <SelectValue
                    placeholder={t("finances.all_branches", "All Branches")}
                  />
                </SelectTrigger>
                <SelectContent className="bg-white">
                  <SelectItem value="all">
                    {t("finances.all_branches", "All Branches")}
                  </SelectItem>
                  {branches.map((branch) => (
            ...
            <Button
              ...
              className="text-white bg-green-600 hover:shadow-lg"
            >
        ...
        >
          <TabsList className="bg-white border p-1 h-auto w-fit">
            <TabsTrigger
              value="reports"
              className="font-bold px-6 data-[state=active]:bg-primary data-[state=active]:text-white"
            >
