...
export default function TeamOrganization() {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-6" dir={i18n.dir()}>
        <div className="flex flex-row gap-2 align-middle items-center">
          <h1 className="text-primary text-3xl font-bold">
            {t("team.title", "Team & Organization")}
          </h1>
          ...
          <TabsContent value="branches">
            <BranchesTab
              branches={branches.filter(
                (b) => b.organization_uuid === currentUser.organization_uuid,
              )}
      ...
      <Dialog open={isEditEmployee} onOpenChange={setIsEditEmployee}>
        {employeeToEdit && (
          <EditEmployeeModal
            employee={employeeToEdit}
            onOpenChange={setIsEditEmployee}
          />
        )}
      </Dialog>
      ...
      >
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("team.confirm_deactivate_title", "Deactivate Employee?")}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t(
                "team.confirm_deactivate_desc",
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                disabled={
                  isVerifyingDeactivatePassword || !deactivatePassword.trim()
                }
          ...
          <AlertDialogFooter className="gap-2">
            ...
            <HoldToConfirmButton
              ...
              disabled={
                !isDeactivatePasswordVerified || isVerifyingDeactivatePassword
              }
            >
      ...
      >
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("team.confirm_delete_branch_title", "Delete Branch?")}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t(
                "team.confirm_delete_branch_desc",
                "This will deactivate the branch and all its employees, projects, and inventory. This action is non-recoverable.",
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="gap-2">
