...
export function BranchesTab({
  ...
  const formatBranchLocation = (location: string | null) => {
    ...
    if (i18n.language === "ar" && locationData) {
      const arParts = [locationData.city_ar, locationData.state_ar].filter(
        Boolean,
      );
        ...
        <div className="flex flex-col items-center justify-center h-64 bg-white rounded-xl border border-dashed border-gray-300 p-8 text-center">
          <h3 className="text-lg font-bold text-gray-400">
            {searchQuery
              ...
              : t("team.no_branches", "No branches found")}
          </h3>
        </div>
      ) : (
              ...
              <CardHeader className="p-4 flex flex-row items-start justify-between space-y-0">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    />
                    <span>
                      {formatBranchLocation(branch.location ?? null) ||
                        t("common.no_location", "No location")}
                    </span>
                  </div>
                </div>
                  ...
                  <DropdownMenuContent align="end" className="bg-white">
                    ...
                    >
                      <img
                        ...
                        alt="edit"
                        className="w-4 h-4 me-2 opacity-70"
                      />
                    ...
                    >
                      <img
                        ...
                        alt="delete"
                        className="w-4 h-4 me-2 opacity-70 group-hover:invert"
                      />
